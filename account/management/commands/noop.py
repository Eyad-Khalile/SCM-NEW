...
def update_blog():
    ...
    remainder_list=RegisterMediaAct.objects.filter(Q(created_at__date=datetime.now().date()-timedelta(days=23))& ~Q(medical_state_q= 0))
    l=[]
    ...
    message ='''                                                                        مرحبا عزيزي 
                ...
                %s, ''' % (l)
    to_email = 'khalile.eyad@gmail.com'
