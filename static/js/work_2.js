$(document).ready(function () {
  ...
  $("tr.add-row td")
    ...
    .click(function () {
      ...
      // :::::::::::::::::::: SALARY :::::::::::::::::::
      // //// Ex " 1 "
      $("#id_registration_media_act-0-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 2 "
      $("#id_registration_media_act-1-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 3 "
      $("#id_registration_media_act-2-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 4 "
      $("#id_registration_media_act-3-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 5 "
      $("#id_registration_media_act-4-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 6 "
      $("#id_registration_media_act-5-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 7 "
      $("#id_registration_media_act-6-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 8 "
      $("#id_registration_media_act-7-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 9 "
      $("#id_registration_media_act-8-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
      ...
      // //// Ex " 10 "
      $("#id_registration_media_act-9-salary")
        .parent("td.field-salary")
        .css("opacity", "0");
  ...
  // SELECT PROFILE
  // $('#id_profile').val($('#id_user').val());
  $("#id_user").change(function () {
    var org = $("#id_user").val();
    $("#id_profile").val(org);
    $("#change_id_profile").attr(
      "href",
      "/admin/account/profile/" + org + "/change/?_to_field=id&amp;_popup=1"
    );
  });
});
django.jQuery;
